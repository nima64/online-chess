    ...
    >
      <defs>
        <linearGradient
          ...
          y1="-249.82"
          y2="-249.82"
          gradientTransform="matrix(.99988 0 0 .97754 30.455 272.6)"
          gradientUnits="userSpaceOnUse"
          xlinkHref="#linearGradient2403"
        ></linearGradient>
        <linearGradient
          ...
          y1="27.266"
          y2="27.266"
          gradientTransform="matrix(1.0155 0 0 1.0103 -.389 .482)"
          gradientUnits="userSpaceOnUse"
        >
        ...
        <linearGradient
          ...
          y1="-264.3"
          y2="-264.3"
          gradientTransform="matrix(.99988 0 0 .97754 29.927 272.6)"
          gradientUnits="userSpaceOnUse"
          xlinkHref="#linearGradient2403"
        ></linearGradient>
        <filter
        ...
        <linearGradient
          ...
          y1="-264.3"
          y2="-264.3"
          gradientTransform="matrix(.99988 0 0 .97754 30.983 272.6)"
          gradientUnits="userSpaceOnUse"
          xlinkHref="#linearGradient2403"
        ></linearGradient>
        <filter
          ...
          colorInterpolationFilters="sRGB"
        >
          <feGaussianBlur stdDeviation="0.216"></feGaussianBlur>
        </filter>
        <filter
          id="filter2218"
          width="1.403"
        ...
        <filter
          ...
          colorInterpolationFilters="sRGB"
        >
          <feGaussianBlur stdDeviation="0.233"></feGaussianBlur>
        </filter>
        <filter
          id="filter2186"
          width="1.124"
          ...
          colorInterpolationFilters="sRGB"
        >
          <feGaussianBlur stdDeviation="0.237"></feGaussianBlur>
        </filter>
        <filter
          id="filter2194"
          width="1.329"
        ...
        <filter
          ...
          colorInterpolationFilters="sRGB"
        >
          <feGaussianBlur stdDeviation="0.338"></feGaussianBlur>
        </filter>
        <filter
          id="filter2226"
          width="1.386"
      ...
      <path
        ...
        filter="url(#filter1764-6-1-4)"
        opacity="0.2"
        transform="matrix(.99988 0 0 .97754 30.455 272.6)"
      ...
      <path
        fill="#fff"
        d="M6.386 16.873l3.733 16.641s.794.057 1.273-2.295z"
        filter="url(#filter2222)"
        opacity="0.3"
      ></path>
      <path
        fill="#fff"
        d="M15.522 14.499l2.34 15.169c-.625 1.087-1.471 2-2.163 2.17z"
        filter="url(#filter2218)"
        opacity="0.25"
      ></path>
      <path
        fill="#fff"
        d="M21.986 31.027l3.027-17.612-.139 15.757c-1.066.913-2.15 1.858-2.888 1.855z"
        filter="url(#filter2214)"
        opacity="0.2"
      ></path>
      <path
        fill="#fff"
        d="M34.459 14.605l-6.78 16.182c.016-.092.467 1.394 3.83-1.244z"
        filter="url(#filter2210)"
        opacity="0.15"
      ></path>
      <path
        fill="#fff"
        d="M33.921 31.807l9.219-14.326-5.598 13.346s-3.153 1.734-3.621.98z"
        filter="url(#filter2186)"
        opacity="0.1"
      ></path>
      <path
        fill="#fff"
        d="M4.184 16.16s-3.017-2.692.934-4.17c.088.013-1.833 2.155-.934 4.17z"
        filter="url(#filter2194)"
        opacity="0.25"
      ></path>
      <path
        fill="#fff"
        d="M13.831 13.031s-3.018-2.692.934-4.17c.09 0-1.796 2.054-.934 4.17z"
        filter="url(#filter2198)"
        opacity="0.2"
      ></path>
      <path
        fill="#fff"
        d="M23.849 12.006s-3.018-2.692.934-4.17c.059 0-1.927 2.09-.934 4.17z"
        filter="url(#filter2202)"
        opacity="0.2"
      ></path>
      <path
        fill="#fff"
        d="M33.935 12.992s-3.018-2.692.934-4.17c.044-.004-1.919 2.093-.934 4.17z"
        filter="url(#filter2206)"
        opacity="0.15"
      ></path>
      <path
        fill="#fff"
        d="M43.431 16.15s-3.018-2.692.934-4.17c.046.017-1.882 2.19-.934 4.17z"
        filter="url(#filter2190)"
        opacity="0.1"
      ></path>
      <path
      ...
      <path
        fill="#fff"
        d="M13.514 39.223c.848-.45 1.7-.66 2.571-.878-.587.84-.616 2.64-.34 3.978 0 0-.89.125-3.224.905z"
        filter="url(#filter2230)"
        opacity="0.1"
      ></path>
      <path
        fill="#fff"
        d="M13.146 38.084c.11-.016.33-.29 2.591-.951-2.014-1.585-3.55-4.075-3.55-4.075-.329.914-.773 1.514-1.415 1.58z"
        filter="url(#filter2226)"
        opacity="0.15"
      ></path>
    </svg>
  );
