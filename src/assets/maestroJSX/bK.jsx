    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          y1="-408.5"
          y2="-408.5"
          gradientTransform="matrix(1.0113 0 0 1.0008 536.22 433.79)"
          gradientUnits="userSpaceOnUse"
        ...
        <filter
          ...
          colorInterpolationFilters="sRGB"
        >
          <feGaussianBlur stdDeviation="0.258"></feGaussianBlur>
        </filter>
        <filter
          id="filter2385"
          width="1.253"
          ...
          colorInterpolationFilters="sRGB"
        >
          <feGaussianBlur stdDeviation="0.508"></feGaussianBlur>
        </filter>
        <filter
          id="filter2393"
          width="1.363"
          ...
          colorInterpolationFilters="sRGB"
        >
          <feGaussianBlur stdDeviation="0.271"></feGaussianBlur>
        </filter>
        <filter
          id="filter2389"
          width="1.212"
        ...
        <filter
          ...
          colorInterpolationFilters="sRGB"
        >
          <feGaussianBlur stdDeviation="0.342"></feGaussianBlur>
        </filter>
        <filter
          id="filter2373"
          width="1.454"
      ...
      <path
        ...
        filter="url(#filter1644-2-3-9-5)"
        opacity="0.2"
        transform="matrix(1.0113 0 0 1.0008 536.22 433.79)"
      ...
      <path
        ...
        stroke="#000"
        strokeLinejoin="round"
        d="M20.9 18.792l4.13 8.653 4.13-8.653s.702-4.768-4.13-4.768c-4.833 0-4.13 4.768-4.13 4.768z"
      ></path>
      <path
        d="M-505.48-419.2c4.757.97.867 10.52.016 13.186.024.025 3.078-5.404 4.02-8.913.09-4.504-3.867-4.392-4.036-4.273z"
        filter="url(#filter1894-1-5-5-2)"
        opacity="0.2"
        transform="matrix(1.0113 0 0 1.0008 536.22 433.79)"
        style={{ mixBlendMode: "normal" }}
      ></path>
      ...
      <path
        ...
        filter="url(#filter2385)"
        opacity="0.3"
      ></path>
      <path
        fill="#fff"
        d="M23.57 23.025l-2.114-4.402s-.69-4.12 3.54-4.056c-4.212 1.33-1.426 8.458-1.426 8.458z"
        filter="url(#filter2393)"
        opacity="0.25"
      ></path>
      <path
        fill="#fff"
        d="M27.026 24.959l2.752-5.929s2.447-2.223 6.116-2.571c-3.947 1.032-6.33 4.875-8.868 8.5z"
